package com.benchpress200.notificationprocessor.singlework.consumer;
...
import com.benchpress200.notificationprocessor.singlework.dispatch.SingleWorkCommentEventDispatcher;
...
public class SingleWorkCommentEventConsumer {
    ...
    @KafkaListener(
            topics = "${spring.kafka.topics.singlework-comment}",
