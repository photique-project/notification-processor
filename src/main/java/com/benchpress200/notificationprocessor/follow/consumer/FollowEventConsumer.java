package com.benchpress200.notificationprocessor.follow.consumer;
...
import com.benchpress200.notificationprocessor.follow.dispatch.FollowEventDispatcher;
...
public class FollowEventConsumer {
    ...
    @KafkaListener(
            topics = "${spring.kafka.topics.follow}",
    ...
    public void consume(ConsumerRecord<String, String> record) {
        ...
        try {
            ...
            log.info(
                    ...
                    eventId,
                    eventType,
                    payload.getFollowerId(),
                    payload.getFolloweeId(),
                    record.topic(),
                    record.partition(),
                    record.offset(),
                    elapsed
